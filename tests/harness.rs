...
async fn mapping_test() {
    ...
    let _result = contract_instance
        .test_store(100, 100, [0; 32], 100)
        .call()
        .await
        .unwrap();

    let result = contract_instance
        .test_retrieve(100, 100, [0; 32], 100)
        .call()
        .await
        .unwrap();
    ...
    let _result = contract_instance
        .test_rebase_map_store(100, 100, [0; 32], 100)
        .call()
        .await
        .unwrap();

    let result = contract_instance
        .test_rebase_map_retrieve(100, 100, [0; 32], 100)
        .call()
        .await
        .unwrap();
